---
title: 区间 DP 合并代价：进阶动态规划训练题解
category: 进阶动态规划
summary: 围绕“区间 DP 合并代价”整理的训练型题解：用专属图解拆出状态、不变量和代码落点。
problem_ids: [1349, 312, 1000, 664, 1411, 879]
order: 106
---

# 区间 DP 合并代价：进阶动态规划训练题解

这篇不是背模板，而是把 **区间 DP 合并代价** 拆成可以手写、可以检查的步骤。训练时建议先遮住题解，只看图和不变量，自己写一版，再展开代码对照。
...
建议按这个顺序刷：#1349, #312, #1000, #664, #1411, #879。每题都先写 Go 或 Rust，再对照题解。
